...
Issue :
    - Fix the issue on When percentage discount not create if directly make invoice without create sales order Customer invoice global discount not updated.
    - Fix the issue on When invoice is posted and move to draft stage and change discount at that time discount amount is not update in journal item.
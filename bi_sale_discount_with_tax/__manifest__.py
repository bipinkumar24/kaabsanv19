...
{
    'name': 'Sales Invoice Discount with Tax Calculation in Odoo',
    'version': '19.0.1.0.0',
    'category': 'Sales',
    'sequence': 14,
    'price': 29,
    'currency': "EUR",
    'summary': 'Sale discount sales discount invoice discount with tax amount global discount sale purchase invoice fixed discount on sale order line sale invoice discount customer discount vendor discount on invoice line discount All in one Discount sale invoice discount',
    'description': """

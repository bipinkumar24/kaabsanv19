...
# See LICENSE file for full copyright and licensing details.
{
    ...
    'data': [
        ...
        'wizard/expense_transfer_view.xml',
        'wizard/stock_request_view.xml',
        'wizard/allocation_request_wizard_view.xml',
        'wizard/expense_transfer_wizard_view.xml',
        ...
        'views/menus.xml',
        'views/approval_level_pr_view.xml',
        'views/view_picking_form_inherit.xml',
        'views/allcation_request_view.xml',
	    'report/approval_flow_report.xml',
    ],
    'application': True,

...
class StockPicking(models.Model):
    ...
    def _compute_cancel_done_picking(self):
        can_cancel_done = self.env.user.has_group("stock_picking_cancel_cs.group_cancel_delivery_order")
        for picking in self:
            picking.cancel_done_picking = can_cancel_done
                ...
                for move in account_moves:
                    ...
                    if landed_cost_rec:
                        raise ValidationError(
                            "This delivery is set in landed cost record %s. Delete it first, then you can cancel this delivery."
